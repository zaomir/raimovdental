...
assert.deepEqual([...materialIds].sort(), expectedIds('ED-MAT', 57), 'material IDs must be continuous ED-MAT-001…057');
...
assert.match(materials, /следующий материал: `ED-MAT-058`/, 'next material ID must advance to ED-MAT-058');
