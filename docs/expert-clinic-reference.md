...
| 🪥 **Home Care Handoff** | [`docs/ssot/EXPERT_DENTAL_HOME_CARE_HANDOFF_SYSTEM.md`](docs/ssot/EXPERT_DENTAL_HOME_CARE_HANDOFF_SYSTEM.md) | Витрина / врач / админ / памятки (DEC-787) |
...
| 📦 **Реестр материалов** | [`docs/raimov/operations/expert-dental/MATERIALS_REGISTER.md`](docs/raimov/operations/expert-dental/MATERIALS_REGISTER.md) | ED-MAT-001..062 — все материалы проекта |
