...
export const approach = {
  id: 'approach',
  kicker: 'Подход · RAIM SMILE SYSTEM',
  title: 'Почему мы оцениваем прикус до эстетики',
  paragraphs: [
    'Expert Dental Studio работает по RAIM SMILE SYSTEM — протоколу Атабека Раимова, '
      + 'в котором эстетика улыбки строится на оценке прикуса и функции сустава, а не наоборот.',
   ...
   */
  authorNote: {
    text: 'Это клиническая позиция Атабека Раимова, разработчика RAIM SMILE SYSTEM.',
...
/* ------------------------------------------------------------------ RAIM SMILE SYSTEM band */

export const raimSmileSystem = {
  id: 'raim-smile-system',
  kicker: 'RAIM SMILE SYSTEM',
  title: 'Клиника работает по именной системе Атабека Раимова',
  lead:
    'RAIM SMILE SYSTEM задаёт маршрут сложного случая: от диагностики прикуса до наблюдения '
    + 'после лечения. Эстетика — следствие функции, а не отправная точка.',
  steps: [
    {
      title: 'Диагностика',
      text: 'Прикус, окклюзия, зубы и дёсны — до разговора о винирах или протезировании.',
    },
    {
      title: 'Проектирование',
      text: 'Фотопротокол, сканирование, wax-up и мокап во рту — форма утверждается до необратимого шага.',
    },
    {
      title: 'Консилиум и план',
      text: 'Сложные случаи решает команда; письменный план с ценами — до начала лечения.',
    },
    {
      title: 'Наблюдение',
      text: 'Контрольные визиты после лечения — тот же клинический контур, без «отпустили и забыли».',
    },
  ],
  note: {
    locked: true,
    text:
      'Система описывает порядок работы клиники. Она не обещает конкретный результат лечения '
      + 'до очного осмотра и диагностики.',
  },
  external: {
    label: 'Пациентская витрина системы',
    href: 'https://raimsmile.com/',
  },
  doctorLink: {
    label: 'О разработчике системы',
    href: '/doctors/raimov-atabek/#raim-smile-system',
  },
};
...
export const process = {
  id: 'process',
  kicker: 'Как это проходит · RAIM SMILE SYSTEM',
