...
export const chief = {
  ...
  metaDescription:
    'Раимов Атабек Саидович — ортодонт-гнатолог, главный врач и основатель Expert Dental Studio. Лечение дисфункции ВНЧС, ортодонтия, обучение врачей и сообщество ОртоКомьюнити.',
