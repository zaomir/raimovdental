...
html = html.replace(
  'Галочкой отмечены только пункты, по которым есть опубликованный результат или зарегистрированное подтверждение. Остальные задачи продолжаются.',
  'Галочкой отмечены только выполненные пункты. Отдельной отметкой «В работе» выделены пункты 12, 14 и 16 — работа по ним уже ведётся и продолжается.'
);
