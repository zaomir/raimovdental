# MENTIONS_REGISTER — public mentions inventory

| ID | Where | What | Source archive | Status | Notes |
|---|---|---|---|---|---|
...
| MEN-008 | bishkek.events congress | Speaker listing | page + excerpt | `discovered` | SPK-001 |
| MEN-009 | who.ca-news.org | Aggregator bio | not archived into excerpts (PII policy) | `excluded` | DOB/PII |
| MEN-010 | GorodWiki | Reviews mirror | not archived for republication | `excluded` | Patient narratives |
