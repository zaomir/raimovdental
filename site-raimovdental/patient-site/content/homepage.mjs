...
export const approach = {
  ...
  paragraphs: [
    'Виниры меняют внешний вид передних зубов. Они не меняют то, как зубы смыкаются и как работает '
      + 'челюстной сустав. При нестабильном прикусе нагрузка на керамику может увеличиваться, поэтому '
      + 'врач отдельно оценивает риск сколов и срок службы реставраций.',
  ...
  steps: [
    ...
    },
    {
      ...
      text:
        ...
        + 'около двух недель. При выраженной скученности или нестабильном прикусе — '
