...
assert.match(app, /function paintQuizOptions/);
assert.match(app, /function cueAdminQuizOptions/);
assert.match(app, /\.quiz-option\.is-correct/);
assert.match(app, /\.quiz-option\.is-wrong/);
assert.match(app, /\.quiz-option\.is-muted/);
assert.match(app, /\.check\.quiz-choice\.is-correct/);
assert.match(app, /\.check\.quiz-choice\.is-wrong/);
assert.match(app, /\.check\.quiz-choice\.is-muted/);
assert.match(app, /\.quiz-feedback\.ok/);
assert.match(app, /\.quiz-feedback\.bad/);
assert.match(app, /\.quiz-mark/);
assert.match(app, /textContent=ok\?'Верно':'Неверно'/);
assert.match(app, /mark\.textContent=i===correct\?'Верно':'Неверно'/);
assert.match(app, /paintQuizOptions\(card,selected,q\.ok\)/);
assert.match(app, /cueAdminQuizOptions\(card,null,q\.ok\)/);
assert.match(app, /cueAdminQuizOptions\(card,selected,q\.ok\)/);
assert.match(app, /data-quiz-choice/);
assert.match(app, /data-onboarding-q/);
assert.match(app, /function showOnboardingQuiz/);
assert.match(app, /finishOnboardingTest/);
assert.match(app, /Проверить ответы/);
assert.match(app, /o\.answers\[day\]/);
assert.match(app, /showOnboardingQuiz\(\{reviewed:true,answers:o\.answers\[day\]\}\)/);
